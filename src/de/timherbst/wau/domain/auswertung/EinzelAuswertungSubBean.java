...
public class EinzelAuswertungSubBean {
	...
	public EinzelAuswertungSubBean(String name, String vorname, String verein, String jahrgang, Wertung boden, Wertung seitpferd, Wertung ringe, Wertung sprung, Wertung barren, Wertung reck, Double gesamt, Integer platz) {
		super();
		this.name = name;
